...
const categories = [
  ...
  },
  {
    ...
    description:
      "Professional event hosts, emcees, and presenters to manage and elevate your events with charismatic presence.",
    count: "100+",
    href: "/artists/hosts",
    color: "from-pink-500 to-rose-500",
    features: ["Event Hosting", "Corporate Emcees", "Show Presenters"],
  },
];
